...
Role-based login for Driver and User

Custom GPS pointer for buggy icon

Real-time map updates using WebSocket
...
User logs in and views the buggy’s position on the map.
